...
describe('Inspector Utilities', () => {
  ...
  describe('String Checks', () => {
    ...
    it('should validate unit strings', () => {
      ...
      expect(isUnitString(null as any)).toBe(false);
      expect(isUnitString(undefined as any)).toBe(false);
      expect(isUnitString(123 as any)).toBe(false);
    });
    ...
    it('should validate boolean strings', () => {
      ...
      expect(isBooleanString(null as any)).toBe(false);
      expect(isBooleanString(undefined as any)).toBe(false);
      expect(isBooleanString(true as any)).toBe(false);
    });
  ...
  describe('Number Checks', () => {
    ...
    it('should validate positive numbers', () => {
      ...
      expect(isPositive(undefined as any)).toBe(false);
      expect(isPositive('123' as any)).toBe(false);
    });
  });
